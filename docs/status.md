# Status — Sub-GHz Telemetry Radio

**Not designed.** Benchmark board 23 of 32, at
scaffolding stage.
...
| Fixed requirements extracted | 14, each bound to verbatim brief text |
| Open decisions recorded | 20, none answered |
